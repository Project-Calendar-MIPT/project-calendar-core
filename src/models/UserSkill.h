...
class UserSkill
{
  public:
     ...
     */
    explicit UserSkill(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UserSkill(const Json::Value &pJson) noexcept(false);
     ...
     */
    UserSkill(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<UserSkill>;
    friend drogon::orm::BaseBuilder<UserSkill, true, true>;
    friend drogon::orm::BaseBuilder<UserSkill, true, false>;
    friend drogon::orm::BaseBuilder<UserSkill, false, true>;
    friend drogon::orm::BaseBuilder<UserSkill, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UserSkill>;
#endif
