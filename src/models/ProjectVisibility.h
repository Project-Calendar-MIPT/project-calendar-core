...
class ProjectVisibility
{
  public:
     ...
     */
    explicit ProjectVisibility(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ProjectVisibility(const Json::Value &pJson) noexcept(false);
     ...
     */
    ProjectVisibility(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    ProjectVisibility() = default;
  ...
  private:
    friend drogon::orm::Mapper<ProjectVisibility>;
    friend drogon::orm::BaseBuilder<ProjectVisibility, true, true>;
    friend drogon::orm::BaseBuilder<ProjectVisibility, true, false>;
    friend drogon::orm::BaseBuilder<ProjectVisibility, false, true>;
    friend drogon::orm::BaseBuilder<ProjectVisibility, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ProjectVisibility>;
#endif
  ...
  public:
    ...
    {
        static const std::string sql="select * from " + tableName + " where project_id = $1";
        return sql;
    }

    static const std::string &sqlForDeletingByPrimaryKey()
    {
        static const std::string sql="delete from " + tableName + " where project_id = $1";
        return sql;
    }
