...
class AppUser
{
  public:
     ...
     */
    explicit AppUser(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit AppUser(const Json::Value &pJson) noexcept(false);
     ...
     */
    AppUser(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    const bool &getValueOfVisibility() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<bool> &getVisibility() const noexcept;
  ...
  private:
    friend drogon::orm::Mapper<AppUser>;
    friend drogon::orm::BaseBuilder<AppUser, true, true>;
    friend drogon::orm::BaseBuilder<AppUser, true, false>;
    friend drogon::orm::BaseBuilder<AppUser, false, true>;
    friend drogon::orm::BaseBuilder<AppUser, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<AppUser>;
#endif
