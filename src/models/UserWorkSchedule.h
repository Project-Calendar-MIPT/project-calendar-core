...
class UserWorkSchedule
{
  public:
     ...
     */
    explicit UserWorkSchedule(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit UserWorkSchedule(const Json::Value &pJson) noexcept(false);
     ...
     */
    UserWorkSchedule(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    UserWorkSchedule() = default;
  ...
  private:
    friend drogon::orm::Mapper<UserWorkSchedule>;
    friend drogon::orm::BaseBuilder<UserWorkSchedule, true, true>;
    friend drogon::orm::BaseBuilder<UserWorkSchedule, true, false>;
    friend drogon::orm::BaseBuilder<UserWorkSchedule, false, true>;
    friend drogon::orm::BaseBuilder<UserWorkSchedule, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<UserWorkSchedule>;
#endif
