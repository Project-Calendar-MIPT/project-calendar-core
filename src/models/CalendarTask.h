...
class CalendarTask
{
  public:
     ...
     */
    explicit CalendarTask(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit CalendarTask(const Json::Value &pJson) noexcept(false);
     ...
     */
    CalendarTask(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    CalendarTask() = default;
  ...
  private:
    friend drogon::orm::Mapper<CalendarTask>;
    friend drogon::orm::BaseBuilder<CalendarTask, true, true>;
    friend drogon::orm::BaseBuilder<CalendarTask, true, false>;
    friend drogon::orm::BaseBuilder<CalendarTask, false, true>;
    friend drogon::orm::BaseBuilder<CalendarTask, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<CalendarTask>;
#endif
