...
class TaskNote
{
  public:
     ...
     */
    explicit TaskNote(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit TaskNote(const Json::Value &pJson) noexcept(false);
     ...
     */
    TaskNote(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
  ...
  private:
    friend drogon::orm::Mapper<TaskNote>;
    friend drogon::orm::BaseBuilder<TaskNote, true, true>;
    friend drogon::orm::BaseBuilder<TaskNote, true, false>;
    friend drogon::orm::BaseBuilder<TaskNote, false, true>;
    friend drogon::orm::BaseBuilder<TaskNote, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<TaskNote>;
#endif
