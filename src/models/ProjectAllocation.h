...
class ProjectAllocation
{
  public:
    struct Cols
    {
        ...
        static const std::string _hours_per_day;
    };
     ...
     */
    explicit ProjectAllocation(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ProjectAllocation(const Json::Value &pJson) noexcept(false);
     ...
     */
    ProjectAllocation(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column weekday  */
    ///Get the value of the column weekday, returns the default value if the column is null
    const int32_t &getValueOfWeekday() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getWeekday() const noexcept;
    ///Set the value of the column weekday
    ...
    /**  For column hours_per_day  */
    ///Get the value of the column hours_per_day, returns the default value if the column is null
    const std::string &getValueOfHoursPerDay() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getHoursPerDay() const noexcept;
    ///Set the value of the column hours_per_day
    void setHoursPerDay(const std::string &pHoursPerDay) noexcept;
    void setHoursPerDay(std::string &&pHoursPerDay) noexcept;
    void setHoursPerDayToNull() noexcept;
  ...
  private:
    friend drogon::orm::Mapper<ProjectAllocation>;
    friend drogon::orm::BaseBuilder<ProjectAllocation, true, true>;
    friend drogon::orm::BaseBuilder<ProjectAllocation, true, false>;
    friend drogon::orm::BaseBuilder<ProjectAllocation, false, true>;
    friend drogon::orm::BaseBuilder<ProjectAllocation, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ProjectAllocation>;
#endif
    ...
    std::shared_ptr<std::string> hoursPerDay_;
    struct MetaData
    {
